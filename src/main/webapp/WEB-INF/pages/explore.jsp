...
<link href="${pageContext.request.contextPath}/css/font-awesome.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/css/simple-line-icons.css"
	rel="stylesheet">
...
<body class="notransition">
	...
	<div id="header">
		...
		<div class="headerUserWraper">
			<a href="#" class="userHandler dropdown-toggle"
				...
				src="${pageContext.request.contextPath}/images/avatar-1.png"
				alt="avatar">
	...
	<div id="wrapper">
		...
		<div id="content">
			...
			<div class="resultsList" id="resultList"></div>
		</div>
		<div class="clearfix"></div>
	</div>
	...
	<script
		src="http://maps.googleapis.com/maps/api/js?v=3.9&libraries=geometry&libraries=places&sensor=false"
	...
	<script src="${pageContext.request.contextPath}/js/explore.js"
		type="text/javascript"></script>
